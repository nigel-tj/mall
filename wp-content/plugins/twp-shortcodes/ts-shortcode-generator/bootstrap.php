...
if( !function_exists('return_terms_for_tsg_template') ) :
	function return_terms_for_tsg_template( $tax = 'category', $id = true ) {
		$terms = get_terms( $tax, array( 'hide_empty' => true, 'cache_results' => false) );
		$output = array();
...
if( !function_exists('twp_get_product_cats') ) :
  function twp_get_product_cats() { 
    global $wpdb;
...
if( !function_exists('twp_get_mailpoet_form') ) :
  function twp_get_mailpoet_form() {
