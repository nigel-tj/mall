        ...
        <div class="woo-multi-currency wmc-shortcode plain-horizontal">
			<?php foreach ( $links as $k => $link ) {
                ...
                <div class="wmc-currency <?php echo esc_attr( $class ) ?>">
                    <a href="<?php echo $class ? '#' : esc_url( $link ) ?>"><?php echo esc_html( $k ) ?></a>
                </div>
			<?php } ?>
        </div>
		<?php
	...
	public function shortcode_layout6( $atts, $content = null ) {
        ...
        <div class="woo-multi-currency wmc-shortcode plain-horizontal layout6">
			...
			foreach ( $links as $k => $link ) {
                ...
                <div class="wmc-currency <?php echo esc_attr( $class ) ?>">
                    <a rel="nofollow"
                       href="<?php echo $class ? '#' : esc_url( $link ) ?>"><?php echo esc_html( get_woocommerce_currency_symbol( $k ) ) ?></a>
                </div>
			<?php } ?>
        </div>
		<?php
            ...
            <div class="wmc-currency-wrapper">
                ...
                <div class="wmc-sub-currency">
					<?php foreach ( $links as $k => $link ) {
                        ...
                        <div class="wmc-currency">
                            <a rel="nofollow"
                               href="<?php echo esc_url( $link ) ?>"><?php echo get_woocommerce_currency_symbol( $k ); ?></a>
                        </div>
					<?php } ?>
                </div>
            </div>
