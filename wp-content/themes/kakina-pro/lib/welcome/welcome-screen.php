...
class kakina_Welcome {
	...
	public function kakina_welcome_admin_notice() {
		...
		<div class="updated notice is-dismissible">
			<p><?php printf( esc_html( 'Welcome! Thank you for choosing %1s! To fully take advantage of the best our theme can offer please make sure you visit our %2s.', 'kakina' ), 'Kakina PRO', '<a href="' . esc_url( admin_url( 'themes.php?page=kakina-welcome' ) ) . '">' . esc_html( 'welcome page', 'kakina' ) . '</a>' ); ?></p>
			<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=kakina-welcome' ) ); ?>" class="button" style="text-decoration: none;"><?php printf( esc_html( 'Get started with %1s', 'kakina' ), 'Kakina PRO' ); ?></a></p>
		</div>
		<?php
	}
	...
	public function kakina_welcome_register_menu() {
		add_theme_page( 'About Kakina', __( 'About Kakina PRO', 'kakina' ), 'activate_plugins', 'kakina-welcome', array( $this, 'kakina_welcome_screen' ) );
	}
