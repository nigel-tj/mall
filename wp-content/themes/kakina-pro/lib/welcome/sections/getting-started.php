...
<div id="getting_started" class="kakina-tab-pane active">
	...
	<div class="kakina-tab-pane-center">
		...
		<p><?php printf( esc_html__( 'We want to make sure you have the best experience using %1s and that is why we gathered here all the necessary informations for you. We hope you will enjoy using %2s, as much as we enjoy creating great products.', 'kakina' ), 'Kakina PRO', 'Kakina PRO' ); ?>
	...
	<div class="kakina-tab-pane-center">
		...
		<p><?php printf( esc_html__( 'Need more details? Please check our full documentation for detailed information on how to use %s.', 'kakina' ), 'Kakina PRO' ); ?></p>
		<p><a href="<?php echo esc_url( 'http://demo.themes4wp.com/documentation/category/kakina-pro/' ); ?>" class="button button-primary"><?php esc_html_e( 'Read full documentation', 'kakina' ); ?></a></p>
	...
	<div class="kakina-tab-pane-half kakina-tab-pane-first-half">
		...
		<h4><?php esc_html_e( 'MailPoet Newsletters', 'kakina' ); ?></h4>
		<p><?php esc_html_e( 'Send newsletters post notifications or autoresponders from WordPress easily.', 'kakina' ); ?></p>
		<?php if ( is_plugin_active( 'wysija-newsletters/index.php' ) ) { ?>
			<p><span class="kakina-w-activated button"><?php esc_html_e( 'Already activated', 'kakina' ); ?></span></p>
		<?php	}	else { ?>
			<p><a href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'update.php?action=install-plugin&plugin=wysija-newsletters' ), 'install-plugin_wysija-newsletters' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Install MailPoet Newsletters', 'kakina' ); ?></a></p>
		<?php	} ?>
	...
	<div class="kakina-tab-pane-half">
		...
		<h4><?php esc_html_e( 'YITH WooCommerce Ajax Search', 'kakina' ); ?></h4>
		<p><?php esc_html_e( 'Allows your users to search products in real time.', 'kakina' ); ?></p>
		<?php if ( is_plugin_active( 'yith-woocommerce-ajax-search/init.php' ) ) { ?>
			<p><span class="kakina-w-activated button"><?php esc_html_e( 'Already activated', 'kakina' ); ?></span></p>
		<?php	}	else { ?>
			<p><a href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'update.php?action=install-plugin&plugin=yith-woocommerce-ajax-search' ), 'install-plugin_yith-woocommerce-ajax-search' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Install YITH WooCommerce Ajax Search', 'kakina' ); ?></a></p>
		<?php	} ?>
		...
		<!-- Contact form 7 -->
		<h4><?php esc_html_e( 'Contact Form 7', 'kakina' ); ?></h4>
		<p><?php esc_html_e( 'Contact form plugin.', 'kakina' ); ?></p>
		<?php if ( is_plugin_active( 'contact-form-7/wp-contact-form-7.php' ) ) { ?>
			<p><span class="kakina-w-activated button"><?php esc_html_e( 'Already activated', 'kakina' ); ?></span></p>
		<?php	}	else { ?>
			<p><a href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'update.php?action=install-plugin&plugin=contact-form-7' ), 'install-plugin_contact-form-7' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Install Contact Form 7', 'kakina' ); ?></a></p>
		<?php	} ?>
